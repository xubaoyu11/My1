...
import com.example.day12.app.App;
 ...
 * @Author: deshuai
 * @CreateDate: 2020/1/11 9:02
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/1/11 9:02
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class NetUtil {
     ...
     */
    @SuppressLint("StaticFieldLeak")
    public void TuPian(final String imagePatg, final ImageView imageView){
        final boolean pd = Pd();
        if (!pd){
            Toast.makeText(App.context, "网络异常", Toast.LENGTH_SHORT).show();
        }
